...
surf chatgpt "help me debug" --timeout 300        # Custom timeout
```
...
surf aimode "review" --model gpt-4o              # Specify model
surf aimode "analyze" --file document.pdf        # With file attachment
```
...
```bash
surf ai "analyze this page"          # Uses GOOGLE_API_KEY env var
surf ai "summarize" --with-page      # Include current page context
```
...
surf claude "review this code" --with-page        # Analyze current page
surf claude "help me debug" --timeout 300         # Custom timeout
```
...
```bash
surf aimode "what is quantum computing"
surf aimode "explain this page" --with-page       # Include page context
surf aimode "compare options" --deep               # Deep research mode
surf aimode "latest news on AI" --model gemini-2.5-flash  # Model selection
```
...
**AI Mode Notes:**
- Uses `nem=143` parameter for AI Mode
